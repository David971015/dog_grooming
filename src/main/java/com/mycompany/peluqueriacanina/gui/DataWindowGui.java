...
public class DataWindowGui extends javax.swing.JFrame {
    int xMouse, yMouse;
    LogicController logicController = new LogicController();

    public DataWindowGui() {
//        logicController = new LogicController();
    ...
    private void initComponents() {
        ...
        jPanelBackground.add(jLabelTitle, new org.netbeans.lib.awtextra.AbsoluteConstraints(140, 30, -1, -1));
        ...
        jLabelSaveData.setText("Guardar");
    ...
    private void jLabelSaveDataMouseClicked(java.awt.event.MouseEvent evt) {//GEN-FIRST:event_jLabelSaveDataMouseClicked
        logicController.saveData(
                jTextFieldClientNumber.getText(),
          ...
          JOptionPane.showMessageDialog(jPanelBackground, "¡Se guardó la información correctamente!");
